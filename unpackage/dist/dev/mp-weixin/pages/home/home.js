...
try {
  components = {
    fuiDialog: function() {
      return __webpack_require__.e(/*! import() | components/fui-dialog/fui-dialog */ "components/fui-dialog/fui-dialog").then(__webpack_require__.bind(null, /*! @/components/fui-dialog/fui-dialog.vue */ 133))
    },
    navCard: function() {
      return __webpack_require__.e(/*! import() | components/navCard/navCard */ "components/navCard/navCard").then(__webpack_require__.bind(null, /*! @/components/navCard/navCard.vue */ 140))
    },
...
(0, _vuex.createNamespacedHelpers)("homeStore"),mapState = _createNamespacedHelp.mapState,mapActions = _createNamespacedHelp.mapActions;var _default =
{
  ...
  onLoad: function onLoad() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var loginTimesOutAuth;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              _this.getData();
              //此数据接口不需要校验TOKEN;
              _context.next = 3;return _API.default.relicManageAPI.getUserInfo();case 3:loginTimesOutAuth = _context.sent;
